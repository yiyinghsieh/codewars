...
class Solution(object):
    def twoSum(self, nums, target):
            ...
            for i in range(l):
                for ii in range(l):
                    ...
                    if num_sort[i] + num_sort[ii] == target:
                        # return [i, ii]
                        # result.append([num_sort[i], num_sort[ii]])
        ...
        #                 return sorted([i, ii])
        #                 # result.append([nums[i], nums[ii]])
        #                 newnum = [nums[i]] + [nums[ii]]
        #                 print(newnum)
        #                 # resultt = []
        #                 # ans = []
        #                 # for i, c in enumerate(nums):
